...
class BlankWorkoutActivity : AppCompatActivity(), CreateTemplateView {
    ...
    override fun setupListener(){
        ...
        binding.finish.setOnClickListener{
            ...
            if (binding.workoutName.text.toString().equals("")){
                ...
                AlertDialog.Builder(this@BlankWorkoutActivity)
...
//                            val workout_name = input.text.toString()
//                            Log.e("workout",workout_name)
//                            if(workout_name == ""){
//                                Toast.makeText(applicationContext, "Please Input Workout Name", Toast.LENGTH_SHORT).show()
//                            }else{
////                                dialog.cancel()
//                            }
//
